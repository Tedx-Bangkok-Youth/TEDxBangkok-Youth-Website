  ...
  return (
    <section className="wrap" aria-label="Make it you typing section">
      ...
      <style jsx>{`
        ...
        .band { position: absolute; left: 50%; transform: translateX(-50%); width: min(92vw, var(--card-w)); height: var(--band-h); background: url('/Landing/sliderPoster/abstract-confetti-shapes-seamless-pattern-creative-minimalist-style-art-background-for-children-or-trendy-design-with-basic-shapes-simple-party-confetti-texture-childish-scribble-shape-backdrop-vector.jpg') center/cover no-repeat; filter: saturate(115%); border-radius: 8px; opacity: 0.95; pointer-events: none; }
